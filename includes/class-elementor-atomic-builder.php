...
final class Elementor_Atomic_Builder
{
    ...
    private function root_section(array $section): array
    {
        ...
        // ---- Group nodes into logical containers via Container Hierarchy Engine ----
        $grid             = new Grid_Model($frame_w);
        $engine           = new Container_Hierarchy_Engine($grid);
        $section_children = $engine->group($section['children'] ?? [], $frame_x, $section_y, $frame_w);
